...
const techStack = [
  ...
  {
    langImage: "images/techstack-page/node.png",
    langName: "Node",
  ...
  {
    langImage: "images/techstack-page/mongodb.png",
    langName: "MongoDB",
    langDesc: "<li>MongoDB is a source-available, cross-platform, document-oriented database program. Classified as a NoSQL database product, MongoDB utilizes JSON-like documents with optional schemas.</li>",
  },
  {
  ...
  {
    langImage: "images/techstack-page/react.png",
    langName: "React",
